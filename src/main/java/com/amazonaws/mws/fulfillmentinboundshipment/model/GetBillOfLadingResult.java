...
/**
 * GetBillOfLadingResult complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="GetBillOfLadingResult"&gt;
 *    &lt;complexContent&gt;
...
@XmlType(name="GetBillOfLadingResult", propOrder={
    "transportDocument"
})
@XmlRootElement(name = "GetBillOfLadingResult")
public class GetBillOfLadingResult extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "GetBillOfLadingResult",this);
    }
     ...
     */
    public GetBillOfLadingResult(TransportDocument transportDocument) {
        this.transportDocument = transportDocument;
    }
