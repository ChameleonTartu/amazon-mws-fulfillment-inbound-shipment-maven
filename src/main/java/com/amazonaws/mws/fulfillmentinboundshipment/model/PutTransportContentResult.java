...
/**
 * PutTransportContentResult complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="PutTransportContentResult"&gt;
 *    &lt;complexContent&gt;
...
@XmlType(name="PutTransportContentResult", propOrder={
    "transportResult"
})
@XmlRootElement(name = "PutTransportContentResult")
public class PutTransportContentResult extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "PutTransportContentResult",this);
    }
     ...
     */
    public PutTransportContentResult(TransportResult transportResult) {
        this.transportResult = transportResult;
    }
     ...
     * Default constructor.
     */
    public PutTransportContentResult() {
        super();
    }
