...
/**
 * ListInboundShipmentItemsResult complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="ListInboundShipmentItemsResult"&gt;
 *    &lt;complexContent&gt;
...
@XmlType(name="ListInboundShipmentItemsResult", propOrder={
    "itemData",
    "nextToken"
})
...
public class ListInboundShipmentItemsResult extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "ListInboundShipmentItemsResult",this);
    }
     ...
     * Value constructor.
     *
     * @param itemData a {@link com.amazonaws.mws.fulfillmentinboundshipment.model.InboundShipmentItemList} object.
     * @param nextToken a {@link java.lang.String} object.
     */
    public ListInboundShipmentItemsResult(InboundShipmentItemList itemData,String nextToken) {
        this.itemData = itemData;
        this.nextToken = nextToken;
    }
