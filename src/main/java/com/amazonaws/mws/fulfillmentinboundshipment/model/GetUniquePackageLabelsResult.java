...
/**
 * GetUniquePackageLabelsResult complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="GetUniquePackageLabelsResult"&gt;
 *    &lt;complexContent&gt;
...
@XmlType(name="GetUniquePackageLabelsResult", propOrder={
    "transportDocument"
})
@XmlRootElement(name = "GetUniquePackageLabelsResult")
public class GetUniquePackageLabelsResult extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "GetUniquePackageLabelsResult",this);
    }
     ...
     */
    public GetUniquePackageLabelsResult(TransportDocument transportDocument) {
        this.transportDocument = transportDocument;
    }
     ...
     * Default constructor.
     */
    public GetUniquePackageLabelsResult() {
        super();
    }
