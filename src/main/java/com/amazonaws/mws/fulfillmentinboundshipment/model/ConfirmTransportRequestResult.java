...
/**
 * ConfirmTransportRequestResult complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="ConfirmTransportRequestResult"&gt;
 *    &lt;complexContent&gt;
...
@XmlType(name="ConfirmTransportRequestResult", propOrder={
    "transportResult"
})
@XmlRootElement(name = "ConfirmTransportRequestResult")
public class ConfirmTransportRequestResult extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "ConfirmTransportRequestResult",this);
    }
     ...
     */
    public ConfirmTransportRequestResult(TransportResult transportResult) {
        this.transportResult = transportResult;
    }
     ...
     * Default constructor.
     */
    public ConfirmTransportRequestResult() {
        super();
    }
