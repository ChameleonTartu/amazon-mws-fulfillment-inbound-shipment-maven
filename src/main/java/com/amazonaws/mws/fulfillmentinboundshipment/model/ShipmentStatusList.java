...
/**
 * ShipmentStatusList complex type.
 *
 * XML schema:
 *
 * <pre>
...
@XmlRootElement(name = "ShipmentStatusList")
public class ShipmentStatusList extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "ShipmentStatusList",this);
    }
     ...
     */
    public ShipmentStatusList(List<String> member) {
        this.member = member;
    }
