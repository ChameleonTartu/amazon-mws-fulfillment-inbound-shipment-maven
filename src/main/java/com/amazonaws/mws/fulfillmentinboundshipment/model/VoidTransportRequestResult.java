...
/**
 * VoidTransportRequestResult complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="VoidTransportRequestResult"&gt;
 *    &lt;complexContent&gt;
...
@XmlType(name="VoidTransportRequestResult", propOrder={
    "transportResult"
})
@XmlRootElement(name = "VoidTransportRequestResult")
public class VoidTransportRequestResult extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/", "VoidTransportRequestResult",this);
    }
     ...
     */
    public VoidTransportRequestResult(TransportResult transportResult) {
        this.transportResult = transportResult;
    }
     ...
     * Default constructor.
     */
    public VoidTransportRequestResult() {
        super();
    }
