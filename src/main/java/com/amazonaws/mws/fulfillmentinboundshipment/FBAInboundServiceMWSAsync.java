...
/**
 * <p>FBAInboundServiceMWSAsync interface.</p>
 *
 * @author dmytro
 * @version $Id: $Id
 */
public interface FBAInboundServiceMWSAsync extends FBAInboundServiceMWS {
     ...
     * @return {@code Future<ConfirmPreorderResponse>} response.
     */
     ...
     * @return {@code Future<ConfirmTransportRequestResponse>} response.
     */
     ...
     * @return {@code Future<CreateInboundShipmentResponse>} response.
     */
     ...
     * @return {@code Future<CreateInboundShipmentPlanResponse>} response.
     */
     ...
     * @return {@code Future<EstimateTransportRequestResponse>} response.
     */
     ...
     * @return {@code Future<GetBillOfLadingResponse>} response.
     */
     ...
     * @return {@code Future<GetInboundGuidanceForASINResponse>} response.
     */
     ...
     * @return {@code Future<GetInboundGuidanceForSKUResponse>} response.
     */
     ...
     * @return {@code Future<GetPackageLabelsResponse>} response.
     */
     ...
     * @return {@code Future<GetPalletLabelsResponse>} response.
     */
     ...
     * @return {@code Future<GetPreorderInfoResponse>} response.
     */
     ...
     * @return {@code Future<GetPrepInstructionsForASINResponse>} response.
     */
     ...
     * @return {@code Future<GetPrepInstructionsForSKUResponse>} response.
     */
     ...
     * @return {@code Future<GetTransportContentResponse>} response.
     */
     ...
     * @return {@code Future<GetUniquePackageLabelsResponse>} response.
     */
     ...
     * @return {@code Future<ListInboundShipmentItemsResponse>} response.
     */
     ...
     * @return {@code Future<ListInboundShipmentItemsByNextTokenResponse>} response.
     */
     ...
     * @return {@code Future<ListInboundShipmentsResponse>} response.
     */
     ...
     * @return {@code Future<ListInboundShipmentsByNextTokenResponse>} response.
     */
     ...
     * @return {@code Future<PutTransportContentResponse>} response.
     */
     ...
     * @return {@code Future<UpdateInboundShipmentResponse>} response.
     */
     ...
     * @return {@code Future<VoidTransportRequestResponse>} response.
     */
